...
AFRAME.registerComponent('jato', {
    ...
    init: function() {
        ...
        document.getElementById('planar').addEventListener("click", function() {onButtonClick(0); } );
        document.getElementById('chair').addEventListener("click", function() {onButtonClick(1); } );
        document.getElementById('twist boat').addEventListener("click", function() {onButtonClick(2); } );
        document.getElementById('boat').addEventListener("click", function() {onButtonClick(3); } );

        var coords = []
        var atoms = []
        var bonds = []

        let requestURL = 'https://149.170.119.111:8080/xmas/Cyclohexane.json'
    ...
    onButtonClick: function(evt){
        ...
        request.onload = function() {
            ...
            const test = request.response;
            coords = test.PC_Compounds[0].coords[0].conformers[evt];
            atoms = test.PC_Compounds[0].atoms.element;
            bonds = test.PC_Compounds[0].bonds;
            console.log(test);
